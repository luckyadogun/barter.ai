    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accomplishnment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Accomplishment')),
                ('portfolio', models.ManyToManyField(blank=True, to='core.Portfolio')),
